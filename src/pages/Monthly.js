...
const Monthly = () => {
  ...
  const calculateCategoryStats = () => {
    ...
    const totalAmount = categoryParticipants.reduce(
        ...
        datasets: [
          {
            data: [
              stats.totalAmount,
              stats.absent *
                (selectedCategory === "Senior Staff"
                  ? 5000
                  : selectedCategory === "Member"
                    ? 2500
                    : 1000), // Different expected amounts per category
            ],
  ...
  const summaryCards = [
    ...
    },
    {
      ...
      icon: (
        <AccountBalanceWalletIcon sx={{ fontSize: 40, color: "#6366f1" }} />
      ),
    },
  ];
          ...
          >
            <CardContent>
              <Typography variant="h6" sx={{ mb: 2 }}>
                {selectedCategory} Attendance Trend
              </Typography>
